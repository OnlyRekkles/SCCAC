...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="#" role="button" id="pushmenuleft"><i class="fas fa-bars"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index.php?<?php echo (parse_url($url, PHP_URL_QUERY));?>" class="nav-link">Inicio</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
      ...
      <nav class="mt-2" id="Sidebar-Menu">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item " onclick="contenido('introduccion',this)">
            <a href="#" class="nav-link ">
              <img src="../IMAGES/icons/introduccion.png" alt="" style="height: 1.5rem;"></i>
              <p>Introducción</p>
            </a>
          </li>
                    ...
                    <li class="nav-item">
                      <a href="#" class="nav-link">
                        <img src="../IMAGES/icons/cursos.png" alt="" style="height: 1.5rem;"></i>
                        <p>
                          Capacitación
                      ...
                      <ul class="nav nav-treeview">
                        <li class="nav-item">
                          <a href="#" class="nav-link">
                            <img src="../IMAGES/icons/puntod.png" alt="" style="height: 1rem;"></i>
                            <p>
                          ...
                          <ul class="nav nav-treeview">
                            <li class="nav-item" onclick="contenido('Interpretacion_1',this)">
                              <a href="#" class="nav-link">
                                <img src="../IMAGES/icons/puntodd.png" alt="" style="height: 1rem;"></i>
                                <p>Sesión 1</p>
                              </a>
                            </li>
          ...
          <li class="nav-item " >
            <a href="../Inicio/html/proceso.html" class="nav-link ">
              <img src="../IMAGES/icons/puntod.png" alt="" style="height: 1.5rem;"></i>
              <p>Organización
              <i class="fas fa-angle-left right"></i> 
              </p>
            </a>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../Inicio/html/tortuga.html" class="nav-link">
                      <img src="../IMAGES/icons/punto.png" alt="" style="height: 1rem;"></i>
                      <p>Liderazgo
                      </p>
                    </a>
            ...
            <li class="nav-item " >
            <a href="../Inicio/html/proceso.html" class="nav-link ">
              <img src="../IMAGES/icons/mapeo.png" alt="" style="height: 1.5rem;"></i>
              <p>Proceso
              <i class="fas fa-angle-left right"></i> 
              </p>
            </a>
            ...
            <a href="../Inicio/html/riesgos.html" class="nav-link">
             <img src="../IMAGES/icons/riesgo.png" alt="" style="height: 1.5rem;"></i>
              <p>Riesgos y Oportunidades</p>
            </a>
          </li>


          <li class="nav-item " onclick="contenido('produccion',this)">
            <a href="#" class="nav-link ">
              <img src="../IMAGES/icons/produccion.png" alt="" style="height: 1.5rem;"></i>
              <p>Recursos</p>
            </a>
          </li>
          ...
          <li class="nav-item " onclick="contenido('riesgos',this)">
            <a href="#" class="nav-link ">
              <img src="../IMAGES/icons/documentos.png" alt="" style="height: 1.5rem;"></i>
              <p>Operación</p>
            </a>
          </li>
          ...
          <li class="nav-item " onclick="contenido('proveedores',this)">
            <a href="#" class="nav-link ">
              <img src="../IMAGES/icons/proveedor.png" alt="" style="height: 1.5rem;"></i>
              <p>Proveedores</p>
            </a>
          </li>
          ...
          <li class="nav-item " onclick="contenido('mejora',this)">
            <a href="#" class="nav-link ">
              <img src="../IMAGES/icons/administracion.png" alt="" style="height: 1.5rem;"></i>
              <p>Desempeño</p>
            </a>
          </li>
          ...
          <li class="nav-item " onclick="contenido('introduccion',this)">
            <a href="#" class="nav-link ">
              <img src="../IMAGES/icons/mejora.png" alt="" style="height: 1.5rem;"></i>
              <p>Mejora</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" id="btn_sesion_c">
              <img src="../IMAGES/icons/cerrar.png" alt="" style="height: 1.5rem;"></i>
              <p>Cerrar sesión</p>
            </a>
          </li>
    ...
    <section class="cantact_info">
        <section class="info_title">
            ...
            <div class="col-lg-11 mb-2">
											<div class="mb-1">
												<input class="btn" type="file" id="formFile" name="addfile" accept="image/png,image/jpeg,image/jpg" required>
											</div>
